...
template <> struct DeviceTraits<float> {
    using Vec2 = float2;
    static __device__ __forceinline__ bool gt(float a, float b) { return a > b; }
    static __device__ __forceinline__ bool lt(float a, float b) { return a < b; }
...
template <> struct DeviceTraits<double> {
    using Vec2 = double2;
    static __device__ __forceinline__ bool gt(double a, double b) { return a > b; }
    static __device__ __forceinline__ bool lt(double a, double b) { return a < b; }
...
template <> struct DeviceTraits<__half> {
    using Vec2 = __half2;
    static __device__ __forceinline__ bool gt(__half a, __half b) { return __hgt(a, b); }
    static __device__ __forceinline__ bool lt(__half a, __half b) { return __hlt(a, b); }
...
template <> struct DeviceTraits<int32_t> {
    using Vec2 = int2;
    static __device__ __forceinline__ bool gt(int32_t a, int32_t b) { return a > b; }
    static __device__ __forceinline__ bool lt(int32_t a, int32_t b) { return a < b; }
    static __device__ __forceinline__ int32_t min(int32_t a, int32_t b) { return a < b ? a : b; }
    static __device__ __forceinline__ int32_t max(int32_t a, int32_t b) { return a > b ? a : b; }
...
template <> struct DeviceTraits<uint32_t> {
    using Vec2 = uint2;
    static __device__ __forceinline__ bool gt(uint32_t a, uint32_t b) { return a > b; }
    static __device__ __forceinline__ bool lt(uint32_t a, uint32_t b) { return a < b; }
    static __device__ __forceinline__ uint32_t min(uint32_t a, uint32_t b) { return a < b ? a : b; }
    static __device__ __forceinline__ uint32_t max(uint32_t a, uint32_t b) { return a > b ? a : b; }
