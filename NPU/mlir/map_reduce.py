    ...
    with Context(), Location.unknown():
        ...
        with InsertionPoint(module.body):
            ...
            def npu_device():
                ...
                cfg_fifo = object_fifo("cfg_fifo", ShimTile, ComputeTile, 1, memref_4)
                ...
                @runtime_sequence(memref_4, memref_1024, memref_1024)
                def seq(cfg, out, in_buf):
                    npu_dma_memcpy_nd(metadata="cfg_fifo", bd_id=3, mem=cfg, sizes=[1, 1, 1, 4], strides=[1, 1, 1, 1])
                    npu_dma_memcpy_nd(metadata="out_candidates", bd_id=4, mem=out, sizes=[1, 1, 4, 256], strides=[1, 1, 256, 1])
