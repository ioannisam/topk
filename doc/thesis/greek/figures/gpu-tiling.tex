\begin{figure}[H]
    ...
    \begin{tikzpicture}[x=1.0cm, y=1.0cm]
        ...
        \node[note, anchor=north, align=center] at (3.60,-6.05)
            {Η μετρούμενη κίνηση περνά από $7n$ σε $22n$ έως $29n$ όταν
             το $k'$ ξεπεράσει το πλακίδιο.};

    \end{tikzpicture}
    \caption[Ταξινομημένο μπλοκ και πλακίδιο κοινής μνήμης]{Η σχέση του ταξινομημένου μπλοκ με το πλακίδιο της κοινής μνήμης. Ένα
