\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption[Συγχώνευση διαδοχικών επιπέδων σε ένα πέρασμα]{Η συγχώνευση διαδοχικών επιπέδων σε ένα πέρασμα. Κάθε
    ζεύγος βελών είναι μία ανάγνωση και μία εγγραφή ολόκληρου του πίνακα. Στο (α)
    κάθε επίπεδο είναι ξεχωριστό πέρασμα προς τη μνήμη. Στο (β) τα επίπεδα
    ομαδοποιούνται κατά απόσταση $j$ και μόνο η τελευταία ομάδα διατηρεί ξεχωριστό
    πέρασμα. Οι αριθμοί του σχήματος είναι ενδεικτικοί.}
