\begin{figure}[H]
    ...
    \begin{tikzpicture}[x=1.0cm, y=1.0cm]
        ...
        \node[panel, font=\scriptsize\bfseries] at (-0.55,1.55) {(α) το κατώφλι της ρίζας, $k=4$};
        ...
        \begin{scope}[yshift=-3.55cm]
            \node[panel, font=\scriptsize\bfseries] at (-0.55,1.10) {(β) το σχήμα \tl{map-reduce}};
            ...
            \node[rowlab, font=\tiny] at (ch0.west) {\tl{map}};
            ...
            \node[rowlab, font=\tiny] at (0.10,-1.45) {\tl{reduce}};
    ...
    \end{tikzpicture}
    \caption[Επιλογή με σωρούς και σχήμα \tl{map-reduce}]{Η επιλογή με σωρούς και η παραλληλοποίησή της. Στο (α) ο σωρός
    ελαχίστου συγκρατεί τα \tl{k} καλύτερα στοιχεία που έχουν εξεταστεί, οπότε η
    ρίζα του, δηλαδή το μικρότερο από αυτά, λειτουργεί ως κατώφλι εισόδου. Ένα
    νέο στοιχείο απορρίπτεται με \emph{μία} σύγκριση, ενώ μόνο όσα υπερβαίνουν το
    κατώφλι κοστίζουν αναδιάταξη $O(\log k)$. Η ασυμμετρία αυτή είναι που κάνει
    τον αλγόριθμο ταχύτατο σε τυχαία είσοδο και αργό σε αύξουσα. Στο (β) η
    είσοδος διαμερίζεται και κάθε εργάτης διατηρεί δικό του σωρό χωρίς κανέναν
    συγχρονισμό· τα μερικά αποτελέσματα συγχωνεύονται στο τέλος. Επειδή όμως κάθε
    σωρός πρέπει πρώτα να γεμίσει για να αρχίσει να φιλτράρει, το πλήθος των
    εργατών που συνεισφέρουν πραγματικά φράσσεται από τον λόγο $n/k$.}
    \label{fig:bg-heap}
\end{figure}
