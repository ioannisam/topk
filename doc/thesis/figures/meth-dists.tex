\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption[Οι πέντε κατανομές εισόδου]{Οι πέντε κατανομές εισόδου, με την τιμή κάθε στοιχείου
    συναρτήσει της θέσης του στον πίνακα. Η \tl{uniform} και η \tl{trimodal} δεν
    έχουν διάταξη και διαφέρουν μόνο ως προς το ποιες τιμές εμφανίζονται· οι δύο
    διατεταγμένες είναι τα άκρα για την επιλογή με σωρό. Στην \tl{adversarial} το
    σώμα των τιμών παραμένει κάτω από τη μέση τιμή του εύρους (διακεκομμένη), με
    μεμονωμένες αιχμές σε τακτά διαστήματα.}
