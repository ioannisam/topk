\begin{figure}[H]
    ...
    \begin{tikzpicture}[x=1.0cm, y=1.0cm]
        ...
        \node[panel, font=\scriptsize\bfseries, anchor=west] at (-1.0, 1.55) {(a) the root threshold, $k=4$};
        ...
        \begin{scope}[yshift=-3.55cm]
            \node[panel, font=\scriptsize\bfseries, anchor=west] at (-1.0, 1.10) {(b) the map-reduce scheme};
            ...
            \node[rowlab, font=\tiny, anchor=west] at (-0.45, 0.52) {map};
            ...
            \node[rowlab, font=\tiny, anchor=west] at (-0.45, -1.45) {reduce};
